...
ultima_fecha = pd.to_datetime(df["FECHA"], dayfirst=True, errors="coerce").max()
...
def sidebar():
    ...
    # PRODUCTOS
        ...
        if df_filtrado.empty:
            ...
            #graph_valor_inventario_mobile(df_productos, date1, date2, tipo_documento)
    ...
    # FUENTE
        ...
        if df_filtrado.empty:
            ...
            tabla_valor_inventario_dos(df_productos, date1, date2, tipo_documento)
